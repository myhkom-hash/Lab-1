...
// Бізнес-логіка для операцій з постами: валідація, перевірка користувача, обробка помилок
// ✓ Вимога: "Додати операції для основної сутності (POST, PUT, DELETE)"
// ✓ Вимога: "Реалізувати валідацію вхідних DTO"
// ✓ Вимога: "повертати коректні HTTP-коди"
...
class PostsService {
  ...
  // Get post by ID with existence check
  ...
  // Create post with validation and user existence check
